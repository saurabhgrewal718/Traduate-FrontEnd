    ...
    render() {
        ...
        return (
          <div style={{position:"relative"}}>
            ...
            <div style={{padding:5,backgroundColor: "white",boxShadow: "0 2px 4px 0 rgba(0,0,0,0.2)"}}>
                <div className="links">
                ...
                <Link to={`${this.props.match.url}/maths`} className="link"><b style={{fontFamily: "Questrial, sans-serif",color:"#a9c6de",fontSize:20}}><i className="fas fa-superscript"></i></b></Link>
                <Link to={`${this.props.match.url}/props-v-state`} className="link"><b style={{fontFamily: "Questrial, sans-serif",color:"#a9c6de",fontSize:20}}><i className="fas fa-fire"></i></b></Link>
