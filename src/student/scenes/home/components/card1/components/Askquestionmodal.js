...
class Askquestionmodal extends Component {
  ...
  render() {
    return (
            <div>
              <Button onClick={this.showModal}>Ask Question</Button>
              <Modal
                style={{top:50}}
                      ...
                      <div style={{width:"100%",paddingTop:50}}>
                        <div style={{ display:"flex"}}>
                           <div style={{ margin:"auto" }}>
                                 ...
                                 <div>
                                   <RadioGroup defaultValue="b" size="large">
                                     <div style={{position:"relative",float:"left"}}>
                                         <RadioButton style={{width:80,height:1,borderColor:"rgba(255, 0, 0, 0)"}} value="a">
                                             <div style={{position:"relative",float:"left"}}>
                                                 ...
                                                 <b><p style={{paddingTop:10,paddingLeft:12}}>Friends</p></b>
                                             </div>
                                         </RadioButton>
                                     </div>
                              ...
                              <div style={{marginTop:130,marginLeft:110}}>
