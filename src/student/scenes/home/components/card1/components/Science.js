        ...
        <div>
          ...
          <div className="cardquestion">
            <div className="containerquestion">
              ...
              <div className="middle">
                 <h3>this is a question that is very much made to ask question and ask ing o=queston really sucks!this is a question that is very much made to ask question and ask ing o=queston really sucks!</h3>
              </div>

              <div className="bottom">
                 <div className="bottom1"><Button>Answer</Button></div>
                 <div className="bottom1"><Button>Mark Doubt</Button></div>
                 <div className="bottom2"><Avatar src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/9222b568654569.5b6446bfab4b2.jpg" style={{height:20,width:20}}/></div>
                 <div className="bottom2"><Avatar src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/9222b568654569.5b6446bfab4b2.jpg" style={{height:20,width:20}}/></div>
                 <div className="bottom2"><Avatar src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/9222b568654569.5b6446bfab4b2.jpg" style={{height:20,width:20}}/></div>
                 <div className="bottom3">
